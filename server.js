  ...
  res.send({
    jobs: [
      ...
      },
      {
        ...
        position: 'Frontend React Developer222',
        url: 'uuu',
        bulkText: 'sfsdfdf',
        status: 'send',
        id: 4,
      ...
      {
        skills: 'React, JavaScript, HTML, CSS',
        position: 'Frontend React Developer3333',
        url: 'sdfsdf',
        bulkText: 'dfdf',
        status: 'send',
        id: 5,
      ...
      {
        skills: 'React, JavaScript, HTML, CSS',
        position: 'Frontend React Developer444',
        url: 'sdfsdf',
        bulkText: 'dfdfdf',
        status: 'declined',
        id: 6,
    ...
    jobSites: [
      ...
      },
      {
        id: 2,
        name: '4scotty.com',
        url: 'https://static.4scotty.com/top-jobs',
      },
      {
        id: 3,
        name: 'monster.de',
        url: 'https://www.monster.de/jobs/suche?q=React+Javascript&where=Berlin&page=1&so=m.s.sh',
      },
      {
        id: 4,
        name: 'germanystartupjobs.com',
        url: 'https://germanystartupjobs.com/search-jobs/?search_keywords=javascript',
      },
      {
        id: 5,
